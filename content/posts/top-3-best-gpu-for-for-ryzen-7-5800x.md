      ...
      <div class="sb_top_three">
      	<div class="sb_p-box">
      		<div class="sb_prate best-overall">
      			<span class="sb-rating">Best Pick</span>
      		</div>
      		...
      		<div class="sb_p-title">
      			<div class="sb_ptitle">                     Product 1 Here                   </div>
      			<p class="sb_p-image">
      				...
      				<div class="meta-list">
      					<div class="meta">
      						<div class="sb_pros-list">
      							<ul>
      								<li class="sb_pros-point">                             Demo product pros                           </li>
      								<li class="sb_pros-point">                             Demo product pros                           </li>
      								<li class="sb_pros-point">                             Demo product pros                           </li>
      							</ul>
      						</div>
      			...
      			<div class="sb_product-price">
      				<a href="#" target="_blank" rel="nofollow noopener noreferrer" class="sb_buy-button">                     Check On Amazon                     <i aria-hidden="true" class="fa fa-chevron-right">
      			</i>
      		</a>
      	</div>
      </div>
...
product_Summary: Best Motherboard for Ryzen 5 5600X - Summary
product_Mheading: ""
product_table: true
the_products:
